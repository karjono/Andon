...
namespace Andon
{
    public partial class FrmAndonOSP : FrmBase
    {
        public int idx_form;
        private string formTitle = "OUTSOLE PRESS";
        ...
        public FrmAndonOSP(int int_idx = 0)
        {
            InitializeComponent();
        ...
        private DataTable fnSearch(string param1, string param2 = "", string param3 = "", string param4 = "", string param5 = "", string param6 = "", string param7 = "", string param8 = "")
        {
            try
            {
                ...
                return ClsDB.LMES_Pkg_Select_Dt("PKG_JJ_ANDON.BOTTOM_OSP_Q");
            }
            catch (Exception ex)
            {
        ...
        private bool fn_Save(string p_action, string p_plant_cd, string p_item_class, string p_wo_no = "", string p_status = "")
        {
            string wh_cd = "";
            ...
            ClsDB.Set_Parameter_Name[i++] = "V_P_ACTION";
            ClsDB.Set_Parameter_Name[i++] = "V_P_PLANT_CD";
            ClsDB.Set_Parameter_Name[i++] = "V_P_WH_CD";
            ClsDB.Set_Parameter_Name[i++] = "V_P_ITEM_CLASS_TYPE";
            ...
            ClsDB.Set_Parameter_Value[i++] = wh_cd;
            ClsDB.Set_Parameter_Value[i++] = p_item_class;
            ClsDB.Set_Parameter_Value[i++] = p_wo_no;
            ClsDB.Set_Parameter_Value[i++] = p_status;

            if (ClsDB.LMES_Pkg_Modify("PKG_JJ_ANDON.BOTTOM_OSP_S"))
                return true;
            else
                return false;
        }
        ...
        private void timerCheckAndon_Tick(object sender, EventArgs e)
        {
            ...
            dtAndon = fnSearch("GET_ANDON", Functions.plant_cd, Functions.item_class, "", Functions.division);
