...
namespace Andon
{
    public partial class FrmAndonIP_CKP : FrmBase
    {
        public int idx_form;
        private string formTitle = "IP";
        ...
        public FrmAndonIP_CKP(int int_idx = 0)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dtGet != null && dtGet.Rows.Count > 0)
                {
                    ...
                    if (dt.Any())
                    {
                        ...
                        {
                            setContentLayout(this.layoutCKP_IP, dtLayout);
                        }
        ...
        private void setContentLayout(Control ctrl, DataTable dtTbl)
        {
            ...
            {
                if (c.Name.ToUpper().Contains("IPI_") || c.Name.ToUpper().Contains("IPU_"))
                {
                    c.Text = "";
