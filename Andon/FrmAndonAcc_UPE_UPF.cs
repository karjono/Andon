...
namespace Andon
{
    public partial class FrmAndonAcc_UPE_UPF : FrmBase
    {
        public int idx_form;
        private string formTitle = "ACCESSORIES (EMBRIODERY && H/F WELDING)";
        ...
        public FrmAndonAcc_UPE_UPF(int int_idx = 0)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dtGet != null && dtGet.Rows.Count > 0)
                {
                    ...
                    if (dt.Any())
                    {
                        ...
                        {
                            setContentLayout(this.layoutAcc_UPE_UPF, dtLayout);
                        }
