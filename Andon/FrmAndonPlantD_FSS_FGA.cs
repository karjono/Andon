...
namespace Andon
{
    public partial class FrmAndonPlantD_FSS_FGA : FrmBase
    {
        public int idx_form;
        ...
        string[] plantA2 = new string[5] { "05", "06", "07", "08", "39" };
        string[] plantA4 = new string[5] { "13", "14", "15", "16", "40" };
        string[] plantD = new string[5] { "25", "26", "27", "28", "29" };
        string[] plantF = new string[5] { "35", "36", "37", "38", "43" };
        string andonLine = "0";
        string andonZone = "0";
        string andonTitle = "";
        string andonOP_CD = "";
        ...
        public FrmAndonPlantD_FSS_FGA(int int_idx = 0)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dtGet != null && dtGet.Rows.Count > 0)
                {
                    ...
                    if (dt.Any())
                    {
                        ...
                        {
                            setContentLayout(this.layoutD_FSS_FGA, dtLayout);
                        }
        ...
        private void setContentLayout(Control ctrl, DataTable dtTbl)
        {
            ...
            foreach (Control c in allControls)
            {
                ...
                if (c.Name.ToUpper().Contains("TITLE_DFS") || c.Name.ToUpper().Contains("TITLE_DFG"))
                {
        ...
        private void layoutD_FSS_FGA_Paint(object sender, PaintEventArgs e)
        {
