...
namespace Andon
{
    public partial class FrmAndonAcc_CINSKIINC : FrmBase
    {
        public int idx_form;
        private string formTitle = "ACCESSORIES (CUP INSOLE / SKIVING / INSOLE CUT)";
        ...
        public FrmAndonAcc_CINSKIINC(int int_idx = 0)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dtGet != null && dtGet.Rows.Count > 0)
                {
                    ...
                    if (dt.Any())
                    {
                        ...
                        {
                            setContentLayout(this.layoutAcc_CinSkiInc, dtLayout);
                        }
