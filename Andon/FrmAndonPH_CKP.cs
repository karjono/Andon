...
namespace Andon
{
    public partial class FrmAndonPH_CKP : FrmBase
    {
        public int idx_form;
        private string formTitle = "PHYLON";
        ...
        public FrmAndonPH_CKP(int int_idx = 0)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (dtGet != null && dtGet.Rows.Count > 0)
                {
                    ...
                    if (dt.Any())
                    {
                        ...
                        {
                            setContentLayout(this.layoutCKP_PH, dtLayout);
                        }
        ...
        private void playSound(string op_cd, int param_line, int param_mc_zone, string param_division, string param_division_type, bool param_open = false, bool param_close = false)
        {
            ...
            if (op_cd == "CMP")
            {
                player = new SoundPlayer((Stream)Properties.Resources.ResourceManager.GetObject("station"));
                player.PlaySync();
            }
            else
            {
